...
QString username, password, id, name, age, gender, department, email, mobile, cnic,
        experienceInYears, currentTask;
int salary, totalLeaves, approvedLeaves, rejectedLeaves, pendingLeaves;
...
void NewEmployee::on_pushButton_clicked()
{
    ...
    qDebug() << username << password << id << name << age << gender << department << email << mobile << cnic << salary << experienceInYears;
