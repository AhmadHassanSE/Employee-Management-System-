    ...
    ui(new Ui::Dashboard)
{
    ...
    ui->empID_label->setText("Employee ID: " + emp.getId());
    ui->empName_label->setText("Name: " + emp.getName());
    ui->empAge_label->setText("Age: " + emp.getAge() + "years");
    ...
    //#######################SALARY_PAGE#######################
    ui->label->setText(QString::number(emp.getSalary()));
    ...
    ui->pending_leaves_label->setText(QString::number(0));
